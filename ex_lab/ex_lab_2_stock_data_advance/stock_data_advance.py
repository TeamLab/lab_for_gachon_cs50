...
def make_stock_data_url(s=None, a=None, b=None, c=None, d=None, e=None, f=None, g="d"):
    ...
    http://real-chart.finance.yahoo.com/table.csv?s=075930.KS&a=0&b=1&c=2013&d=11&e=31&f=2015&g=d

    각 변수별로 의미는 아래와 같음

    Args:
        s (str): 데이터를 받고자 하는 회사의 주식 코드, KOSPI에 상장된 회사는 끝에 .KS를 붙임 ex) 075930.KS
        a (int): 데이터를 받고자 하는 시작날짜의 월 정보를 입력함
        b (int): 데이터를 받고자 하는 시작날짜의 일 정보를 입력함
        c (int): 데이터를 받고자 하는 시작날짜의 년도 정보을 입력함
        d (int): 데이터를 받고자 하는 마지막 날짜의 월 정보를 입력함
    ...
    Examples:
        >>> import stock_data_advance as sdc
        >>> sdc.make_stock_data_url(s="075930.KS", a=0, b=10, c=2014, d=12, e=10, f=2015
        'http://real-chart.finance.yahoo.com/table.csv?s=075930.KS&a=9&b=2014&c=0&d=11&e=10&f=2015&g=d'
        >>> sdc.make_stock_data_url(s="075935.KS", a=0, b=11, c=2001, d=12, e=10, f=2015
        'http://real-chart.finance.yahoo.com/table.csv?s=075935.KS&a=10&b=2001&c=0&d=11&e=10&f=2015&g=d'
    """

    base_url = "url = 'http://real-chart.finance.yahoo.com/table.csv"
    result = None
    # ===Modify codes below=============
