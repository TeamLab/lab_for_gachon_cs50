...
![.vimrc 설정이 안되어 있는 vi editor](https://s3.ap-northeast-2.amazonaws.com/teamlab-gachon/vim_without_vimrc.png)
...
![.vimrc를 처음 설정할 때, .vimrc 파일 내용](https://s3.ap-northeast-2.amazonaws.com/teamlab-gachon/first_vimrc.png)
...
![.vimrc를 처음 설정할 때, .vimrc 파일 내용](https://s3.ap-northeast-2.amazonaws.com/teamlab-gachon/yesterday_test_vi.png)
